	...
	<div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
		...
		<div class="boxed">
            ...
            <div id="page-content">                                                                 
				...
				<a href="action/parent_accept.php<?php echo '?user_id='.$user_id; ?>" class="btn btn-danger">Block</a>												
												</div>
                                            </td>
                                            <?php
												}
											...
											?>
                                              <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
		 	   <a href="action/parent_pending.php<?php echo '?user_id='.$user_id; ?>" class="btn btn-success">Allow</a>												
												</div>
                                            </td>
                                            <?php		
												}
