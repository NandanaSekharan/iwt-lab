                                ...
                                <div class="panel-body pad-no"> 
                                  ...
                                  <div class="tab-base"> 
                                    ...
                                    <div class="card-body">
										...
										<hr/>
										<a href="hospital_search_view_hospital_review_hospital.php<?php echo '?Log_Idh='.$Log_Idh; ?>" class="btn btn-sm btn-default" style="float: left;" >Read Reviews</a>
                                        <?php
											if($PLog_Id=="")
											{
										?>
										<a href="hospital_search_view_hospital_review.php<?php echo '?Log_Idh='.$Log_Idh; ?>" class="btn btn-sm btn-info" style=" margin-left: 5px;" >Write a Reviews</a><br>
                                        <?php
											}
											else
											{
										?>
                                        <a href="#" class="btn btn-sm btn-danger" style=" margin-left: 5px;" >Reviews Writed</a><br>
                                        <?php	
											}
										?>
                                         <a href="hospital_search_view_hospitalb.php<?php echo '?Log_Idh='.$Log_Idh; ?>" class="btn btn-sm btn-success" style="margin-left:230px; margin-top:-55px;" >Booking</a><br>
										<hr/>									
                                            </div>
                                        </div>
                                      </div>                                   
