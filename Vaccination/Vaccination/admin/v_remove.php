            ...
            <div id="page-content">                                                                 
					...
					<div class="col-lg-12">
						<div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">ALL VACCIN</h3>
                            </div>
                ...
                <input id="demo-input-search2" type="text" placeholder="Search" class="form-control" autocomplete="off">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                    ...
                                    <tbody>
									 <?php 
										$result =$db ->prepare("SELECT * FROM vaccine");
										$result->execute();	
									...
									<a href="action/v_remove.php<?php echo '?v_id='.$v_id; ?>" class="btn btn-danger fa  fa-remove"></a>												
												</div>
                                            </td>                                        
										</tr>
                                   <?php } ?>                                
