					...
					<div class="col-lg-8">
						<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Child Search</h3>
								</div>
								<div class="panel-body">
                                   <div class="form-group">
                                     <form method="get" action="vaccination_update_view.php" autocomplete="off">
                                       	<div class="form-group">
                                            <div class="col-sm-6">
                                               ...
                                               <input list="name" required class="form-control" name="name" placeholder="Search">
                                                <datalist id="name">
                                                    <option value="">Select</option>
                                                        <?php
                                                            $result = $db->prepare("SELECT distinct(cname) FROM booking where stat='Accept' and statvtk='Pending'");
                                                            $result->execute();
